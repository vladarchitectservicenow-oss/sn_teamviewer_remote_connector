...
## Overview
sn_teamviewer_remote_connector is a production-grade ServiceNow scoped application developed by Vladimir Kapustin under AGPL-3.0.

## Architecture
```mermaid
graph TD
    SN[ServiceNow Instance] -->|REST| sn_teamviewer_remote_connector
    sn_teamviewer_remote_connector -->|Store| DB[x_sn_teamviewer_remote_connector_tables]
    sn_teamviewer_remote_connector -->|Output| Report[Reports MD/JSON/CSV]
...
See `Validation/TEST CASES/sn_teamviewer_remote_connector/test_suite_SOP.md`
...
## Support
- GitHub Issues: https://github.com/vladarchitectservicenow-oss/sn_teamviewer_remote_connector/issues
- ServiceNow Community: Tag `sn_teamviewer_remote_connector`
